...
```
docker build . --file Dockerfile --tag webots:latest [--build-arg BASE_IMAGE=nvidia/cudagl:10.0-devel-ubuntu18.04] [--build-arg WEBOTS_VERSION=R2020b-rev1] [--build-arg WEBOTS_PACKAGE_PREFIX=_ubuntu-16.04]
```
